...
<div id="container">
  ...
  <div id="bd">
    <div class="wrap ue-clear">
        ...
        <ul class="nav">
          ...
          <li class="konwledge">
            <div class="nav-header"><a href="javascript:;" class="ue-clear"><span>知识管理</span><i class="icon"></i></a></div>
              <ul class="subnav">
            <li><a href="javascript:;" date-src="/index.php/Admin/Knowledge/showList.html">知识列表</a></li>
          ...
          <li class="agency">
            ...
            <ul class="subnav">
            <li><a href="javascript:;" date-src="/index.php/Admin/Dept/showList.html">部门列表</a></li>
      ...
      <div class="content">
        <iframe src="/index.php/Admin/Index/home" id="iframe" width="100%" height="100%" frameborder="0"></iframe>
      </div>
    </div>
  </div>

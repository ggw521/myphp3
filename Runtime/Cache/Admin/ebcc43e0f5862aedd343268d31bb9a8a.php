	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="name"><?php echo ($vo["to_name"]); ?></td>
                ...
                <td class="status">
                    <?php if($vo["isread"] == 0): ?><span style="color:green;">未读</span>
                    <?php else: ?>
                    <span style="color:red;">已读</span><?php endif; ?>
                </td>
                <td class="operate">
                	<a  href ='/index.php/Admin/Email/del/id/<?php echo ($vo["id"]); ?>' onclick="window.confirm('该数据非常重要，你确定要删除吗？');">删除</a> 
                </td>

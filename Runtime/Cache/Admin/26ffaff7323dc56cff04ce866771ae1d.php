...
<div class="main">
	<p class="short-input ue-clear">
    	<label>标题：</label>
        <input name="title" value ="<?php echo ($data["title"]); ?>" type="text" placeholder="标题..." />
        <input type="hidden" name="id" value="<?php echo ($data["id"]); ?>"/>
    </p>
	<p class="short-input ue-clear">
    	<label>缩略图：</label>
        <input name="thumb" type="file"/><font color="red">*注：不修改缩略图则为空*</font>
    </p>
    <p class="short-input ue-clear">
    	<label>作者：</label>
        <input name="author"  value ="<?php echo ($data["author"]); ?>" type="text" placeholder="作者..." />
    </p>
    <p class="short-input ue-clear">
    	<label>描述：
		  <textarea name="description" style="font-family:Microsoft YaHei !important; font-size:14px;" placeholder="请输入内容..." > <?php echo (htmlspecialchars_decode($data["description"])); ?></textarea>
    	</label>
    </p>
    <p class="short-input ue-clear">
    	<label>内容：<script name='content' type="text/plain" id="myEditor" style="width:600px;height:300px;"> <?php echo (htmlspecialchars_decode($data["content"])); ?>
		</script>
		</label>

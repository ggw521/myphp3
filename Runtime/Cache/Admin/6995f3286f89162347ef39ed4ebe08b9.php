...
<div class="table-box">
	<table>
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td class="name"><?php echo ($vol["from_name"]); ?></td>
                ...
                <td class="content"><?php echo (msubstr(htmlspecialchars_decode($vol["content"]),0,8)); ?></td>
                <td class="addtime"><?php echo (date('Y-m-d H:i:s',$vol["addtime"])); ?></td>
                <td class="status"><?php if($vol["isread"] == 0): ?><font color="green">未读</font><?php else: ?><font color="red">已读</font><?php endif; ?>
                </td>
                <td class="operate">
